...
function Home() {
  return (
    <>
      <Header />
      <div className="w-full bg-gradient-to-b from-slate-900 via-slate-800 to-slate-900 pt-12  min-h-screen">
        {/* Carrossel no topo */}
        <Carousel />
        {/* Seção de Promoções */}
        ...
        <div className="bg-slate-800/50 backdrop-blur-sm p-6 rounded-2xl shadow-xl mx-4 mt-12 mb-12 border border-slate-700/20">
